...
std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"NudgelessSpeed", PERSISTENT}, // Nudgeless Lane Change Enable Speed
    ...
    {"ScreenRecorderToggle", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION},
    ...
    {"UseAccSpeedMaps", PERSISTENT}, //SpeedMap
    ...
    {"AutoResumeDistance", PERSISTENT}, //auto_resume distance
    {"AutoResumeSetSpeed", PERSISTENT}, //auto_resume set speed
    {"AutoResumeSetSpeedAct", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, //auto_resume set speed actual, update in onroad.cc
    {"LeadDepartDistance", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION},
    {"CruiseAutoResumeActivated", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, // ESP32 Auto resume status.
    ...
    {"ESP32IPAddress", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, //ESP32 ip address
    ...
    {"LqrtxDistanceRelated", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, // Lead Car Distince Related send out
    {"LqrtxVelocityRelated", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, // Lead Car Velocity Related send out
    {"LqrtxVCruiseKPH", CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION}, // ACC Set Speed send out V Cruise KPH
    //{"LqrtxDebugText",CLEAR_ON_MANAGER_START | CLEAR_ON_OFFROAD_TRANSITION},
