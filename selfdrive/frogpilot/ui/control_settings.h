...
private:
  ...
  std::set<QString> fireTheBabysitterKeys = {"NoLogging", "NoDashCam", "MuteOverheated", "QueitFan", "NoUploads", "OfflineMode"};
  std::set<QString> laneChangeKeys = {"LaneChangeTime", "LaneDetection", "LaneDetectionWidth", "OneLaneChange", "NudgelessSmooth", "NudgelessSpeed"};
  ...
  std::set<QString> qolKeys = {"DisableOnroadUploads", "HigherBitrate", "NavChill", "MinSteerSpeedStandard", "MinSteerSpeedEngage", "PauseLateralOnSignal", "ReverseCruise", "CustomCruise", "CustomCruiseLong", "SetSpeedOffset"};
