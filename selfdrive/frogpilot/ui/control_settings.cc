...
FrogPilotControlsPanel::FrogPilotControlsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  ...
  for (const auto &[param, title, desc, icon] : controlToggles) {
    ...
    if (param == "AdjustablePersonalities") {
      ...
      QStringList models = {"los-angeles", "certified-herbalist", "duck-amigo", "recertified-herbalist", "north-dakota"};
      QStringList modelLabels = {"Los Angeles (Default)", "Certified Herbalist", "Duck Amigo", "Recertified Herbalist", "North Dakota"};
