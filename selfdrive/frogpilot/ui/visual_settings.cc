...
FrogPilotVisualsPanel::FrogPilotVisualsPanel(SettingsWindow *parent) : FrogPilotListWidget(parent) {
  const std::vector<std::tuple<QString, QString, QString, QString>> visualToggles {
    {"CustomTheme", tr("Custom Themes"), "Enable the ability to use custom themes.", "../frogpilot/assets/wheel_images/frog.png"},
    {"HolidayThemes", tr("Holiday Themes"), "The openpilot theme changes according to the current/upcoming holiday. Minor holidays last a day, major holidays (Easter, Christmas, Halloween, etc.) last a week.", ""},
    {"CustomColors", tr("Color Theme"), "Switch out the standard openpilot color scheme with a custom color scheme.\n\nWant to submit your own color scheme? Post it in the 'feature-request' channel in the FrogPilot Discord!", ""},
    {"CustomIcons", tr("Icon Pack"), "Switch out the standard openpilot icons with a set of custom icons.\n\nWant to submit your own icon pack? Post it in the 'feature-request' channel in the FrogPilot Discord!", ""},
    {"CustomSignals", tr("Turn Signals"), "Add custom animations for your turn signals for a personal touch!\n\nWant to submit your own turn signal animation? Post it in the 'feature-request' channel in the FrogPilot Discord!", ""},
    {"CustomSounds", tr("Sound Pack"), "Switch out the standard openpilot sounds with a set of custom sounds.\n\nWant to submit your own sound pack? Post it in the 'feature-request' channel in the FrogPilot Discord!", ""},

    {"AlertVolumeControl", tr("Alert Volume Control"), "Control the volume level for each individual sound in openpilot.", "../frogpilot/assets/toggle_icons/icon_mute.png"},
    {"DisengageVolume", tr("Disengage Volume"), "Related alerts:\n\nAdaptive Cruise Disabled\nParking Brake Engaged\nPedal Pressed\nSpeed too Low", ""},
    {"EngageVolume", tr("Engage Volume"), "Related alerts:\n\nNNFF Torque Controller loaded", ""},
    {"PromptVolume", tr("Prompt Volume"), "Related alerts:\n\nCar Detected in Blindspot\nLight turned green\nSpeed too Low\nSteer Unavailable Below 'X'\nTake Control, Turn Exceeds Steering Limit", ""},
    {"PromptDistractedVolume", tr("Prompt Distracted Volume"), "Related alerts:\n\nPay Attention, Driver Distracted\nTouch Steering Wheel, Driver Unresponsive", ""},
    {"RefuseVolume", tr("Refuse Volume"), "Related alerts:\n\nopenpilot Unavailable", ""},
    {"WarningSoftVolume", tr("Warning Soft Volume"), "Related alerts:\n\nBRAKE!, Risk of Collision\nTAKE CONTROL IMMEDIATELY", ""},
    {"WarningImmediateVolume", tr("Warning Immediate Volume"), "Related alerts:\n\nDISENGAGE IMMEDIATELY, Driver Distracted\nDISENGAGE IMMEDIATELY, Driver Unresponsive", ""},

    {"CameraView", tr("Camera View"), "Choose your preferred camera view for the onroad UI. This is a visual change only and doesn't impact openpilot.", "../frogpilot/assets/toggle_icons/icon_camera.png"},
    {"Compass", tr("Compass"), "Add a compass to your onroad UI.", "../frogpilot/assets/toggle_icons/icon_compass.png"},

    {"CustomAlerts", tr("Custom Alerts"), "Enable custom alerts for various logic or situational changes.", "../frogpilot/assets/toggle_icons/icon_green_light.png"},
    {"GreenLightAlert", tr("Green Light Alert"), "Get an alert when a traffic light changes from red to green.", ""},
    {"LeadDepartingAlert", tr("Lead Departing Alert"), "Get an alert when your lead vehicle starts departing when you're at a standstill.", ""},
    {"LoudBlindspotAlert", tr("Loud Blindspot Alert"), "Enable a louder alert for when a vehicle is detected in your blindspot when attempting to change lanes.", ""},
    {"SpeedLimitChangedAlert", tr("Speed Limit Changed Alert"), "Trigger an alert whenever the current speed limit changes.", ""},

    {"CustomUI", tr("Custom Onroad UI"), "Customize the Onroad UI with some additional visual functions.", "../assets/offroad/icon_road.png"},
    {"AccelerationPath", tr("Acceleration Path"), "Visualize the car's intended acceleration or deceleration with a color-coded path.", ""},
    {"AdjacentPath", tr("Adjacent Paths"), "Display paths to the left and right of your car, visualizing where the model detects lanes.", ""},
    {"BlindSpotPath", tr("Blind Spot Path"), "Visualize your blind spots with a red path when another vehicle is detected nearby.", ""},
    {"FPSCounter", tr("FPS Counter"), "Display the Frames Per Second (FPS) of your onroad UI for monitoring system performance.", ""},
    {"LeadInfo", tr("Lead Info and Logics"), "Get detailed information about the vehicle ahead, including speed and distance, and the logic behind your following distance.", ""},
    {"PedalsOnUI", tr("Pedals Being Pressed"), "Display which pedals are being pressed on the onroad UI below the steering wheel icon.", ""},
    ...
    {"HideLeadMarker", tr("Hide Lead Marker"), "Hide the lead marker from the onroad UI.", ""},
    {"LaneLinesWidth", tr("Lane Lines"), "Adjust the visual thickness of lane lines on your display.\n\nDefault matches the MUTCD average of 4 inches.", ""},
    ...
    {"DriverPrivacyProtectionFake", tr("Driver Privacy Protection"), "Protect the driver's privacy while driving on road.", ""},
    ...
    {"HideSpeed", tr("Hide Speed"), "Hide the speed indicator in the onroad UI. Additional toggle allows it to be hidden/shown via tapping the speed itself.", ""},
    {"MapStyle", tr("Map Style"), "Use a custom map style to be used for 'Navigate on openpilot'.", ""},
    {"WheelSpeed", tr("Use Wheel Speed"), "Use the wheel speed metric as opposed to the artificial speed.", ""},

    {"RandomEvents", tr("Random Events"), "Enjoy a bit of unpredictability with random events that can occur during certain driving conditions.", "../frogpilot/assets/toggle_icons/icon_random.png"},

    {"ScreenManagement", tr("Screen Management"), "Manage your screen's brightness, timeout settings, and hide specific onroad UI elements.", "../frogpilot/assets/toggle_icons/icon_light.png"},
    {"HideUIElements", tr("Hide UI Elements"), "Hide the selected UI elements from the onroad screen.", ""},
    {"ScreenBrightness", tr("Screen Brightness"), "Customize your screen brightness when offroad.", ""},
    {"ScreenBrightnessOnroad", tr("Screen Brightness (Onroad)"), "Customize your screen brightness when onroad.", ""},
    {"ScreenRecorder", tr("Screen Recorder"), "Enable the screen recorder button to record the screen.", ""},
    {"ScreenTimeout", tr("Screen Timeout"), "Customize how long it takes for your screen to turn off.", ""},
    {"ScreenTimeoutOnroad", tr("Screen Timeout (Onroad)"), "Customize how long it takes for your screen to turn off after going onroad.", ""},
    {"StandbyMode", tr("Standby Mode"), "Turn the screen off after your screen times out when onroad but wake it back up when engagement state changes or important alerts are triggered.", ""},

    {"WheelIcon", tr("Steering Wheel Icon"), "Replace the default steering wheel icon with a custom design, adding a unique touch to your interface.", "../assets/offroad/icon_openpilot.png"},
  };
