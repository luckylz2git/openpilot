...
void AnnotatedCameraWidget::drawHud(QPainter &p) {
  ...
  // + "," + QString::number(onstar_gps_altitude, 'f', 0)
  speedStr = QString::number(current_gear_number, 'f', 0) + "," + QString::number(next_gear_number, 'f', 0) + "," + QString::number(onstar_gps_longitude, 'f', 0) + "," + QString::number(onstar_gps_latitude, 'f', 0); // ONSTAR_GPS_TEST
