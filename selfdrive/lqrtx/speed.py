class SpeedMap:
  ...
  def get_acc_speed_display(self, accspeed: float) -> int:
    ...
    if min_value > 0 and (accspeed - min_value) < mid:
      return int(min_key)
    if max_value > 0 and (max_value - accspeed) < mid:
      return int(max_key)
